var loading = {
		...
		status: function (mult) {
			...
			if ($.browser.desktop) {
				...
				$('section').not('.header, #program').find('> *').addClass('wow fadeInUp');
				$('section.header').addClass('wow');
				$('#program').find('.button-label').addClass('wow fadeInUp');
				$('#program').find('> .border > *').addClass('wow fadeInUp');
				new WOW().init();
			}
